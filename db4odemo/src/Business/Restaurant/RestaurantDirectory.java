...
public class RestaurantDirectory {
    ...
    public FoodMenu AddMenuDishes(Restaurant restro,String name,String desc,String amount){
        menu=new FoodMenu(name, desc, amount);
        restro.addDishes(menu);
        return menu;
    }
    
    public void DeleteDishes(Restaurant restro,FoodMenu menu){
