...
public class MenuPanel extends javax.swing.JPanel {
    ...
    Restaurant restro;
    EcoSystem system;
    ArrayList<FoodMenu> items=new ArrayList<FoodMenu>();
    /**
    ...
    public MenuPanel(JPanel userProcessContainer, UserAccount account,EcoSystem system,Restaurant restro) {
     ...
     public void populateTable(){
            ...
            model.setRowCount(0);
                ...
                for(FoodMenu dish:restro.getMenu()){
                     row[0] = dish;
     ...
     public void populateCart(FoodMenu item){
        DefaultTableModel model = (DefaultTableModel) cartTable.getModel();
        model.setRowCount(0);
        
         items.add(item);
         Object[] row = new Object[3];
                for(FoodMenu dish:items){
                     row[0] = dish;
                     row[1] = dish.getDescription();
                     row[2] = dish.getPrice();
    ...
    private void initComponents() {
        ...
        cardBtn.setForeground(new java.awt.Color(51, 153, 0));
        cardBtn.setText("Add to Cart");
        cardBtn.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        cardBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cardBtnActionPerformed(evt);
            }
        });
        add(cardBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 100, 150, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, -1, -1));

        valueLabel.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        valueLabel.setText("<value>");
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 130, -1));

        enterpriseLabel.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        enterpriseLabel.setText("Home Address :");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 200, 150, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, -1, 200));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, -1, 180));

        orderBtn1.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        orderBtn1.setText("Place Order");
        orderBtn1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        orderBtn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                orderBtn1ActionPerformed(evt);
            }
        });
        add(orderBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 280, -1, -1));

        RemoveBtn.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        RemoveBtn.setForeground(new java.awt.Color(204, 0, 0));
        ...
        add(RemoveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 330, -1, 30));
        add(addressTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 200, 170, -1));
        ...
        enterpriseLabel1.setText("PLACE YOUR ORDER ");
        add(enterpriseLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 200, 30));
    ...
    private void cardBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cardBtnActionPerformed
        ...
        if(selectedRow<0){
            ...
            FoodMenu item=(FoodMenu)menuTable.getValueAt(selectedRow, 0);
    ...
    private void orderBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderBtn1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Your Order has been placed","Thank You for your order",JOptionPane.WARNING_MESSAGE);
        sum=0;
        userProcessContainer.remove(this);
        Component[] componentArray = userProcessContainer.getComponents();
        Component component = componentArray[componentArray.length - 1];
    ...
    private void RemoveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveBtnActionPerformed
        ...
        if(selectedRow<0){
            JOptionPane.showMessageDialog(null,"Please select a row to view the details","Warning",JOptionPane.WARNING_MESSAGE);
        }
        else{
            FoodMenu item=(FoodMenu)cartTable.getValueAt(selectedRow, 0);
