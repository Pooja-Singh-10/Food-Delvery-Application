...
public class CustomerAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        restaurentTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RESTAURANT", "CUSTOMER ADDRESS ", "CONTACT INFORMATION "
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 450, 300));
        ...
        add(requestTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 470, -1, -1));

        refreshTestJButton.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        refreshTestJButton.setForeground(new java.awt.Color(0, 102, 0));
        ...
        add(refreshTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 100, -1, -1));

        enterpriseLabel.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        enterpriseLabel.setText("CUSTOMER SECTION ");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 30, 200, 30));

        valueLabel.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        valueLabel.setText("<value>");
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 30, 158, 26));

        valueLabel1.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        valueLabel1.setForeground(new java.awt.Color(51, 0, 153));
        valueLabel1.setText("LOCAL RESTAURANTS");
        add(valueLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, 250, 26));

        valueLabel2.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        valueLabel2.setForeground(new java.awt.Color(51, 0, 153));
        valueLabel2.setText("ORDER HISTORY");
        add(valueLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 90, 158, 26));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 140, -1, 290));
