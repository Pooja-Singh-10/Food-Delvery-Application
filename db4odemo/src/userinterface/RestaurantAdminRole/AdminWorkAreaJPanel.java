...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(manageRestoInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 230, 270, -1));
        ...
        add(manageMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, 190, -1));

        manageOrders.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        manageOrders.setText("Manage All Orders");
        manageOrders.setBorder(new javax.swing.border.MatteBorder(null));
        manageOrders.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                manageOrdersActionPerformed(evt);
            }
        });
        add(manageOrders, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, 180, -1));
        ...
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 80, 160, 30));
