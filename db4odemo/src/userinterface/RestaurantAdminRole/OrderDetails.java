...
public class OrderDetails extends javax.swing.JPanel {
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
         ...
         Object[] row = new Object[3];
                for(FoodMenu dish:order.getOrder()){
                     row[0] = dish;
    ...
    private void initComponents() {
        ...
        orderTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MENU ITEM", "DESCRIPTION", "TOTAL AMOUNT"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 580, 250));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, -1, -1));

        ChangeStatusBtn.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        ChangeStatusBtn.setForeground(new java.awt.Color(51, 102, 0));
        ...
        add(ChangeStatusBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 430, 230, 30));

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 153));
        jLabel2.setText("Order Details");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 60, 220, 40));
